...
Event is the column containing the data that we will have to predict. Let's take a look on the values of this column to have a better understanding of the distribution of the results :

```{r}
table(unlist(train_raw$event))
```

We can see a huge majority of A and C results ... #TODO : ANALYSE THIS
Now, lets convert this column into numerical data to make some plots on it. A will take the value 1, B will be 2 etc. 
